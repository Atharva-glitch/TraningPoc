...
import com.xoriant.XorFakeData.models.Address;
...
public class DataServiceImpl implements DataService {
    ...
    public String generateMockData(RequestModel requestModel) {
        ...
        String jsonObject;
        jsonList = generateEmployeeData(jsonList,requestModel);
    ...
    private List<Object> generateEmployeeData(List<Object> jsonList, RequestModel requestModel){
        ...
        for(int i=0;i < requestModel.getCount(); i++) {
            ...
            Address address = Address.builder().streetName(faker.address().streetName()).cityName(faker.address().cityName()).country(faker.address().country()).build();
